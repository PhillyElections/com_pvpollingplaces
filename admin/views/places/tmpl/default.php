        ...
        <table class="adminlist">
            <thead>
                <tr>
                    ...
                    <th>
                        <?=JHTML::_('select.genericlist', PVCombo::getsFromObject($this->wards, 'id', 'ward', JText::_('Ward')), 'ward', (JRequest::getVar('ward') ? JRequest::getVar('ward') : ''), 'idx', 'value', '', 'ward');?>
                    </th>
