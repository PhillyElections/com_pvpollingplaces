        ...
        <table class="adminlist">
            <thead>
                <tr>
                    ...
                    <th><?=JText::_('Ward');?>
<input type="checkbox" value="1" <?=in_array('1', JRequest::getVar('ward')) ? 'checked' : '';?> \>
<input type="checkbox" value="2" <?=in_array('2', JRequest::getVar('ward')) ? 'checked' : '';?> \>
<input type="checkbox" value="11" <?=in_array('11', JRequest::getVar('ward')) ? 'checked' : '';?> \>
<input type="checkbox" value="12" <?=in_array('12', JRequest::getVar('ward')) ? 'checked' : '';?> \>
