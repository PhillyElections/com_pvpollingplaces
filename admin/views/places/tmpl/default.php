        ...
        <table class="adminlist">
            <thead>
                <tr>
                    ...
                    <th>
                        <?=JHTML::_('select.genericlist', PVCombo::getsFromObject($this->wards, 'id', 'ward', JText::_('Ward')), 'ward', '', 'idx', 'value', '', 'ward');?>
                    </th>
                    <th><?=(isset($this->divisions) && count($this->divisions) ? JHTML::_('select.genericlist', PVCombo::getsFromObject($this->divisions, 'id', 'division_id', JText::_('Division'), 'sort'), 'd_id', '', 'idx', 'value', '', 'd_id') : JText::_('Division'));?></th>
                    <th><?=JText::_('Pin');?></th>
